...
public class AccountModel extends Entity {
    ...
    public static ListProperty addresses, creditCards, favoriteCourses, completedOrders;

    public static class Addresses extends EntityList {}
    public static class CreditCards extends EntityList {}
    public static class FavoriteCourses extends EntityList {}
    ...
    public static final EntityType TYPE = new EntityType(){{
        ...
        favoriteCourses = list(FavoriteCourses.class, tags(Account.favoriteCourses));
    ...
    public AccountModel(String firstName,
        ...
        FavoriteCourses favoriteCoursesList = new FavoriteCourses();
        set(this.favoriteCourses, favoriteCoursesList);
    }
    ...
    public void addFavorite(Entity course){
        EntityList<Entity> favoriteCourses = (FavoriteCourses)get(Account.favoriteCourses);
    ...
    public boolean isFavorite(Entity course){
        EntityList<Entity> favoriteCourses = (FavoriteCourses)get(Account.favoriteCourses);
        for (Entity currCourse : favoriteCourses){
