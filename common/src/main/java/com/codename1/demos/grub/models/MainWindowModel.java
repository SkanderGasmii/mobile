...
public class MainWindowModel extends Entity {
    ...
    public static ListProperty courses;

    public static class Courses extends EntityList {}
    ...
    public static final EntityType TYPE = new EntityType(){{
        ...
        courses = list(Courses.class, tags(MainWindow.courses));
    }};
    ...
    public MainWindowModel(Entity profile, List<Entity> courses){
