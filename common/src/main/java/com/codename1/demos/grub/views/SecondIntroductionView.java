...
public class SecondIntroductionView extends AbstractEntityView {
    ...
    public SecondIntroductionView(Entity entity, Node grubNode, Node introNode) {
        ...
        String imageName = Fissaa.isDarkMode() ? "second-intro-image-dark.png" : "second-intro-image.png";
        ...
        skip.addActionListener(evt -> {
            evt.consume();
            ActionNode action = grubNode.getInheritedAction(Fissaa.SKIP_TO_MAIN_WINDOW);
            if (action != null) {
