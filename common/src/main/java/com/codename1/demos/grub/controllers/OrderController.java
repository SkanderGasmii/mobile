...
public class OrderController extends FormController {
    ...
    OrderView orderView;
    public OrderController(Controller parent, Entity courseEntity, Entity profileEntity, Node mainWindowNode) {
        super(parent);
        ...
        Form orderForm = new Form(courseEntity.getText(Course.name), new BorderLayout());
        orderForm.getToolbar().hideToolbar();

        orderView = new OrderView(courseEntity, profileEntity, viewNode, mainWindowNode);
