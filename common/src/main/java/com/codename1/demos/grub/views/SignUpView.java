...
import com.codename1.demos.grub.services.UserService;
...
public class SignUpView extends AbstractEntityView {
    ...
    public SignUpView(Entity entity, Node applicationControllerViewNode, Node accountViewNode) {
        ...
        Label signUpHeader = new Label("Register", "SignUpHeader");
        ...
        wrapper.add(BorderLayout.CENTER, BoxLayout.encloseY(firstName, lastName, emailAddress, password));
