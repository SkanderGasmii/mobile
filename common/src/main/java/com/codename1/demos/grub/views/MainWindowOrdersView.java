...
import com.codename1.demos.grub.Fissaa;
...
public class MainWindowOrdersView extends AbstractEntityView {
    ...
    public void addCompletedOrder(Entity completedOrder){
        ...
        String backgroundImageName = Fissaa.isDarkMode() ? "set-first-location-background-dark.png" : "set-first-location-background.png";
        ...
        Label drivesAtTheCoursesLabel = new Label ("Drives At The Restaurant", "DrivesAtTheRestaurantLabel");
        String progressImageName = Fissaa.isDarkMode() ? "delivery-progress-dark.png" : "delivery-progress.png";
        ...
        deliveryInfoCnt.add(BorderLayout.CENTER, BoxLayout.encloseY(deliveryProgress, preparingFoodLabel, drivesAtTheCoursesLabel));
