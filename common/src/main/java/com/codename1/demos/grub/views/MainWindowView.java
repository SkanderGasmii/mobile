...
public class MainWindowView extends AbstractEntityView {
    ...
    FavoriteCoursesView favoriteView;
    ...
    public MainWindowView(Entity mainWindowEntity, Node profileNode, Node homeViewNode, Node appNode) {
        ...
        favoriteView = new FavoriteCoursesView((Entity)mainWindowEntity.get(MainWindow.profile), homeViewNode);
    ...
    public void addFavorite(Entity course){
        favoriteView.addFavorite(course);
    }

    public void removeFavorite(Entity course){
        favoriteView.removeFavorite(course);
    }
